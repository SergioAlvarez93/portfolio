<footer class="footer">
    <div class="footer__bg">
        <div class="footer__container">
            <?php if ($contact = get_field('vk', 'options')) { ?>
                <a href="<?php echo $contact; ?>" class="footer-soc" target="_blank">
                    <svg class="footer-soc__vk" viewBox="0 0 97.75 97.75" xmlns="http://www.w3.org/2000/svg">
                        <g>
            ...
            <div class="footer-title">
                ООО «ТАЛАНТ - ДЕТСКИЙ МОНТЕССОРИ ЦЕНТР» <?php echo date("Y"); ?>. ВСЕ ПРАВА ЗАЩИЩЕНЫ.
            </div>
        </div>
    </div>
</footer>
